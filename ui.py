...
class AirScentingUI:
    ...
    def dismiss_status_message(self, event=None):
        """Clear the current status message when clicked"""
        from sv import sv
        sv.status.set("")
    def prev_status_message(self):
        """Navigate to previous status message (placeholder for Phase 2)"""
        pass

    
    def next_status_message(self):
        """Navigate to next status message (placeholder for Phase 2)"""
        pass
